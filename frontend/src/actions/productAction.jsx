...
export const getAdminProduct = () => async (dispatch) => {
  try {
    ...
    const BASE_URL = "http://localhost:4000";
    let link = `${BASE_URL}/api/v1/admin/products`;
...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    const BASE_URL = "http://localhost:4000";
    let link = `${BASE_URL}/api/v1/admin/product/new`;
...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    const BASE_URL = "http://localhost:4000";
    let link = `${BASE_URL}/api/v1/admin/product/${id}`;
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const BASE_URL = "http://localhost:4000";
    let link = `${BASE_URL}/api/v1/reviews?id=${id}`;
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const BASE_URL = "http://localhost:4000";
    let link = `${BASE_URL}/api/v1/reviews?id=${reviewId}&productId=${productId}`;
