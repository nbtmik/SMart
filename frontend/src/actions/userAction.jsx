...
export const login=(email,password)=>async(dispatch)=>{
    try{
        ...
        let link = `${BASE_URL}/api/v1/login`;
...
export const register=(userData)=>async(dispatch)=>{
    try{
        ...
        const BASE_URL = "http://localhost:4000";
        let link = `${BASE_URL}/api/v1/register`;
...
export const loadUser=()=>async(dispatch)=>{
    try{
        ...
        const BASE_URL = "http://localhost:4000";
        let link = `${BASE_URL}/api/v1/me`;//for my prfile
...
export const logout=()=>async(dispatch)=>{
    try{
        const BASE_URL = "http://localhost:4000";
        let link = `${BASE_URL}/api/v1/logout`;//for my prfile
...
export const updatePassword=(passwords)=>async(dispatch)=>{
    try{
        ...
        const config = {headers:{"Content-Type":"application/json"},withCredentials:true};
        const BASE_URL = "http://localhost:4000";
        let link = `${BASE_URL}/api/v1/password/update`;
...
export const resetPassword=(token,passwords)=>async(dispatch)=>{
    try{
        ...
        const BASE_URL = "http://localhost:4000";
        let link = `${BASE_URL}/api/v1/password/reset/${token}`;
...
export const getUserDetails = (id) => async (dispatch) => {
    try {
      ...
      const BASE_URL = "http://localhost:4000";
      let link = `${BASE_URL}/api/v1/admin/user/${id}`;
